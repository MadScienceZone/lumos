...
8\sfrac{1}{2}$''\times$\sfrac{3}{4}$''$ by
\sfrac{1}{8}$''$ thick ($\approx$25.5$\times$2\,cm by 3\,mm thick) aluminum bars (we found these to be readily available at home improvement
...
\begin{description}
\item[\HandRight\ Note:] Take care to make good, solid \ix{solder connections} when installing components.
...
\item[\HandRight\ Note:] We will point out a few places where \acronym{ESD} protection is needed, but
