...
AB 1111aaaa 00000001 01011010 01011010  Exit sleep mode
 ...
 R 1111aaaa 00000011 00100100 01010100  Report device status
   ...
   1111aaaa 00000110 0owbxxxx 0iiiiiii 0ppppppp 0ttttttt 00111100
...
PC 1111aaaa 01110001 0dABCDcc 0ccccccc 00111010 00111101 Set configuration
                       ABCD (0=outputs, 1=inputs)
                       d (DMX512 0=off, 1=on; channel 0=DMX c)
 C 1111aaaa 01110001                            Reserved admin command
      :                                   :
...
<data>::=
  0dABCDcc 0ccccccc 0sfABCDe 0eeeeeee 0mmmmmmm 0mmmmmmm 0qxxxxpp 0ppppppp 
   |\__/\_________/  ||\__/\________/  \______________/  |    \_________/
   | |       |       || |       |            |           |         |
DMX+ |       |       || |       |            |           |         |
sens-+       |       || |       |            |           |         |
DMX channel--+       || |       |            |           |         |
...
transmitted				compiled
00000000             			11111100 		all off
00000001 x				0scccccc		set on/off
00000010 x x 				10cccccc vvvvvvvv	set value
00000011 ...				11111000 nnnnnnnn v+    set bulk
00000100 x x x				11111001 x x x          ramp
00000101 
00000110
00000111        			11110000		sleep
00001000				11110001		wake
00001001 i				11110010 i		exec i
00001010 n				11110011 n s C		rept n -s
00001011 i				11110100 i		call i
00001100 i				11110101 i		chain i
00001101 00obABCD s			11110110 f s		if f -s
00001110 m				11110111 m		wait ms
00001111 				11111111		exit
00010000 x				11111010 x		set c=x
00010001 x y s				11111011 x y s		loop +x to y -s
