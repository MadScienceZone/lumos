...
class LumosLegacyControllerUnit (ControllerUnit):
    """
    ...
    def __init__(self, id, power_source, network, address, resolution=32):
        ...
        ** THIS IS FOR THE OBSOLETE 2.x VERSION OF THE FIRMWARE **
        USE THIS DRIVER TO TALK TO OLD BOARDS, BUT THEY SHOULD BE
        UPGRADED FOR BEST RESULTS.
