...
class TestNetwork (Network):
    ...
    def input(self, remaining_f=None, nbytes=None, mode_switch=True, timeout=1) -> bytes:
            ...
            if remaining_f:
                ...
                raise APIUsageError("You must specify either nbytes or remaining_f (or both) to input()")
