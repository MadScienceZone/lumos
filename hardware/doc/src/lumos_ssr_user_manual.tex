...
\begin{enumerate}
	...
	\item	Disconnect any input sensors and power supply control wire from the Lumos
		controller.
	\item	Install a jumper to short pins 4 and 5 of J11 (labeled ``\acronym{ICSP}''
		on the board).
...
additional, higher-power \acronym{SSR} or a ``snubber'' circuit) to the Lumos circuit, which is outside the
