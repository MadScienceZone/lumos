...
class RenardControllerUnitTest (unittest.TestCase):
    ...
    def testInit(self):
        ...
        self.ssr.flush()
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=00=00=00=00=00')
    ...
    def testBufferedIO(self):
        ...
        self.assertEqual(self.n.buffer, b'')
        self.ssr.flush()
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=00=FF=00=00=FF')
        self.ssr.set_channel_off(7)
        self.ssr.set_channel_on(0)
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=00=FF=00=00=FF')
        self.ssr.flush()
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=00=FF=00=00=FF~=82=FF=00=19=00=FF=00=00=00')
        self.ssr.set_channel(5, 0x66)
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=00=FF=00=00=FF~=82=FF=00=19=00=FF=00=00=00')
        self.ssr.flush()
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=00=FF=00=00=FF~=82=FF=00=19=00=FF=00=00=00~=82=FF=00=19=00=FFf=00=00')
        self.ssr.flush()
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=00=FF=00=00=FF~=82=FF=00=19=00=FF=00=00=00~=82=FF=00=19=00=FFf=00=00')
        self.n.reset()
        self.assertEqual(self.n.buffer, b'')
    ...
    def testOnOff(self):
        ...
        self.ssr.flush()
        self.assertEqual(self.n.buffer, b'~=82=00=00=19=FF=00=00=00=00')
    ...
    def testDimmer(self):
        ...
        self.ssr.flush()
        self.assertEqual(self.n.buffer, b'~=82=0F=000=00=00=00=00=00')
    ...
    def testWarm(self):
        ...
        for i,j in (
            (0x01,b'~=82=00=00=19=00=00=00=00=00'), 
            (0x00,b'~=82=00=00=19=00=00=00=00=00'),
            (0x02,b'~=82=00=00=19=00=00=00=00=00'),
            (0x05,b'~=82=00=00=19=00=00=00=00=00'),
            (0x18,b'~=82=00=00=19=00=00=00=00=00'),
            (0x19,b'~=82=00=00=19=00=00=00=00=00'),
            (0x20,b'~=82=00=00=20=00=00=00=00=00'),
            (0x02,b'~=82=00=00=19=00=00=00=00=00'),
            (0x30,b'~=82=00=000=00=00=00=00=00'),
            (0x50,b'~=82=00=00P=00=00=00=00=00'),
            (0x80,b'~=82=00=00=80=00=00=00=00=00'),
            (0xa0,b'~=82=00=00=A0=00=00=00=00=00'),
            (0xff,b'~=82=00=00=FF=00=00=00=00=00'),
            (0x00,b'~=82=00=00=19=00=00=00=00=00'),
            (0x50,b'~=82=00=00P=00=00=00=00=00'),
        ):
            self.n.reset()
    ...
    def testEscapeCodes(self):
        ...
        for i,j in (
            (0x01,b'~=82=00=00=19=00=00=00=00=00'), 
            (0x7c,b'~=82=00=00|=00=00=00=00=00'), 
            (0x7d,b'~=82=00=00=7F/=00=00=00=00=00'), 
            (0x7e,b'~=82=00=00=7F0=00=00=00=00=00'), 
            (0x7f,b'~=82=00=00=7F1=00=00=00=00=00'), 
            (0x80,b'~=82=00=00=80=00=00=00=00=00'), 
        ):
            self.n.reset()
            self.ssr.set_channel(2, i)
