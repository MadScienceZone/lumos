...
#
# LUMOS GUI SEQUENCE EDITOR PREVIEW CANVAS WIDGET
#
...
# tools: 
#  lines poly rect filled-rect circle filled-c arc etc select-channel width
#  play stop pause rew ff start end
...
# XXX auto-scale window and canvas to fit window
